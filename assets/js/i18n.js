(function () {
  ...
  var phrases = {
    ...
    'Orthopaedic Surgeon · Bengaluru': 'ಮೂಳೆ ಶಸ್ತ್ರಚಿಕಿತ್ಸಕ · ಬೆಂಗಳೂರು',
    'Orthopaedic Doctor in JP Nagar & RR Nagar': 'ಜೆ ಪಿ ನಗರ ಮತ್ತು ಆರ್ ಆರ್ ನಗರದಲ್ಲಿ ಮೂಳೆ ವೈದ್ಯರು',
    'Trusted Orthopaedic Care. Expert Hands. Better Mobility.': 'ನಂಬಿಕಸ್ಥ ಮೂಳೆ ಚಿಕಿತ್ಸೆ. ನುರಿತ ಕೈಗಳು. ಉತ್ತಮ ಚಲನೆ.',
    'Dr. Chethan Kumar – Consultant Orthopaedic, Joint Replacement, Sports Injury & Trauma Specialist in JP Nagar and RR Nagar, Bengaluru.': 'ಡಾ. ಚೇತನ್ ಕುಮಾರ್ – ಬೆಂಗಳೂರಿನ ಜೆ ಪಿ ನಗರ ಮತ್ತು ಆರ್ ಆರ್ ನಗರದಲ್ಲಿ ಕನ್ಸಲ್ಟಂಟ್ ಆರ್ಥೊಪೀಡಿಕ್, ಕೀಲು ಬದಲಾವಣೆ, ಕ್ರೀಡಾ ಗಾಯ ಮತ್ತು ಟ್ರಾಮಾ ತಜ್ಞರು.',
    ...
    Arthritis: 'ಸಂಧಿವಾತ',
    'Pediatric Orthopaedics': 'ಮಕ್ಕಳ ಮೂಳೆ ಚಿಕಿತ್ಸೆ',
    ...
    'Orthopaedic services': 'ಮೂಳೆ ಸೇವೆಗಳು',
    'Patient education blog': 'ರೋಗಿ ಶಿಕ್ಷಣ ಬ್ಲಾಗ್',
    'Orthopaedic clinic in JP Nagar': 'ಜೆ ಪಿ ನಗರದಲ್ಲಿ ಮೂಳೆ ಕ್ಲಿನಿಕ್',
    'Orthopaedic clinic in RR Nagar': 'ಆರ್ ಆರ್ ನಗರದಲ್ಲಿ ಮೂಳೆ ಕ್ಲಿನಿಕ್',
    ...
    'Dr. Chethan Kumar is a consultant orthopaedic surgeon serving patients in JP Nagar, RR Nagar, Banashankari, Uttarahalli, Kanakapura Road, Jayanagar and South Bengaluru.': 'ಡಾ. ಚೇತನ್ ಕುಮಾರ್ ಜೆ ಪಿ ನಗರ, ಆರ್ ಆರ್ ನಗರ, ಬನಶಂಕರಿ, ಉತ್ತರಹಳ್ಳಿ, ಕನಕಪುರ ರಸ್ತೆ, ಜಯನಗರ ಮತ್ತು ದಕ್ಷಿಣ ಬೆಂಗಳೂರಿನ ರೋಗಿಗಳಿಗೆ ಸೇವೆ ಸಲ್ಲಿಸುವ ಕನ್ಸಲ್ಟಂಟ್ ಮೂಳೆ ಶಸ್ತ್ರಚಿಕಿತ್ಸಕರು.',
    'He combines surgical expertise with conservative treatment approaches, helping patients understand their condition and explore all appropriate options before making a decision.': 'ಅವರು ಶಸ್ತ್ರಚಿಕಿತ್ಸಾ ಪರಿಣತಿಯನ್ನು ಸಂರಕ್ಷಣಾತ್ಮಕ ಚಿಕಿತ್ಸಾ ವಿಧಾನಗಳೊಂದಿಗೆ ಸಂಯೋಜಿಸಿ, ರೋಗಿಗಳು ತಮ್ಮ ಸ್ಥಿತಿಯನ್ನು ಅರ್ಥಮಾಡಿಕೊಳ್ಳಲು ಮತ್ತು ನಿರ್ಧಾರಕ್ಕೆ ಮುಂಚೆ ಎಲ್ಲಾ ಸೂಕ್ತ ಆಯ್ಕೆಗಳನ್ನು ಪರಿಶೀಲಿಸಲು ಸಹಾಯ ಮಾಡುತ್ತಾರೆ.',
    'Hip and Knee Replacement': 'ಸೊಂಟ ಮತ್ತು ಮೊಣಕಾಲು ಬದಲಾವಣೆ',
    'Primary joint replacement for advanced arthritis, supported by structured rehabilitation.': 'ಸಂರಚಿತ ಪುನರ್ವಸತಿಗೆ ಬೆಂಬಲಿತವಾದ ಮುಂದುವರಿದ ಸಂಧಿವಾತಕ್ಕೆ ಪ್ರಾಥಮಿಕ ಕೀಲು ಬದಲಾವಣೆ.',
    'Minimally invasive procedures for conditions affecting the meniscus, ACL, shoulder and cartilage.': 'ಮೆನಿಸ್ಕಸ್, ಎಸಿಎಲ್, ಭುಜ ಮತ್ತು ಕಾರ್ಟಿಲೇಜ್ ಅನ್ನು ಬಾಧಿಸುವ ಸ್ಥಿತಿಗಳಿಗೆ ಕನಿಷ್ಠ ಆಕ್ರಮಣಕಾರಿ ವಿಧಾನಗಳು.',
    'Sports Injuries': 'ಕ್ರೀಡಾ ಗಾಯಗಳು',
    'Assessment and treatment of ligament, tendon and overuse injuries in amateur and competitive athletes.': 'ಸಾಮಾನ್ಯ ಮತ್ತು ಸ್ಪರ್ಧಾತ್ಮಕ ಕ್ರೀಡಾಪಟುಗಳಲ್ಲಿ ನಾರು, ಟೆಂಡನ್ ಮತ್ತು ಅತಿಯಾದ ಬಳಕೆಯ ಗಾಯಗಳ ಮೌಲ್ಯಮಾಪನ ಮತ್ತು ಚಿಕಿತ್ಸೆ.',
    'Trauma and Fractures': 'ಟ್ರಾಮಾ ಮತ್ತು ಮುರಿತಗಳು',
    'Care for accident- and fall-related bone injuries, ranging from simple to complex fractures.': 'ಸರಳದಿಂದ ಸಂಕೀರ್ಣ ಮುರಿತಗಳವರೆಗೆ ಅಪಘಾತ ಮತ್ತು ಬೀಳುವಿಕೆ ಸಂಬಂಧಿತ ಮೂಳೆ ಗಾಯಗಳ ಆರೈಕೆ.',
    'Spine and Shoulder Conditions': 'ಬೆನ್ನು ಮತ್ತು ಭುಜ ಸ್ಥಿತಿಗಳು',
    'Evaluation and treatment of slipped discs, sciatica, frozen shoulder, rotator cuff problems and cervical spondylosis.': 'ಸ್ಲಿಪ್ ಡಿಸ್ಕ್, ಸಯಾಟಿಕಾ, ಫ್ರೋಜನ್ ಶೋಲ್ಡರ್, ರೊಟೇಟರ್ ಕಫ್ ಸಮಸ್ಯೆಗಳು ಮತ್ತು ಸರ್ವೈಕಲ್ ಸ್ಪಾಂಡಿಲೋಸಿಸ್‌ನ ಮೌಲ್ಯಮಾಪನ ಮತ್ತು ಚಿಕಿತ್ಸೆ.',
    'Bone Health': 'ಮೂಳೆ ಆರೋಗ್ಯ',
    'Meet the same doctor at two convenient clinics in South Bengaluru. Book an appointment by WhatsApp or phone.': 'ದಕ್ಷಿಣ ಬೆಂಗಳೂರಿನ ಎರಡು ಅನುಕೂಲಕರ ಕ್ಲಿನಿಕ್‌ಗಳಲ್ಲಿ ಅದೇ ವೈದ್ಯರನ್ನು ಭೇಟಿ ಮಾಡಿ. ವಾಟ್ಸ್‌ಆ್ಯಪ್ ಅಥವಾ ದೂರವಾಣಿಯಲ್ಲಿ ಅಪಾಯಿಂಟ್‌ಮೆಂಟ್ ಕಾಯ್ದಿರಿಸಿ.',
    'Treatment Philosophy:': 'ಚಿಕಿತ್ಸಾ ತತ್ವ:',
    'Hospital Affiliations:': 'ಆಸ್ಪತ್ರೆ ಸಂಬಂಧಗಳು:',
    ...
    'Clinics in South Bengaluru': 'ದಕ್ಷಿಣ ಬೆಂಗಳೂರಿನಲ್ಲಿ ಕ್ಲಿನಿಕ್‌ಗಳು',
    ...
    'Dr. Chethan Kumar · Orthopaedic Surgeon – JP Nagar & RR Nagar': 'ಡಾ. ಚೇತನ್ ಕುಮಾರ್ · ಮೂಳೆ ಶಸ್ತ್ರಚಿಕಿತ್ಸಕ – ಜೆ ಪಿ ನಗರ ಮತ್ತು ಆರ್ ಆರ್ ನಗರ',
    'Consultant Orthopaedic Surgeon in JP Nagar and RR Nagar, Bengaluru. Patient-first, evidence-based orthopaedic care.': 'ಜೆ ಪಿ ನಗರ ಮತ್ತು ಆರ್ ಆರ್ ನಗರ, ಬೆಂಗಳೂರಿನಲ್ಲಿ ಕನ್ಸಲ್ಟಂಟ್ ಮೂಳೆ ಶಸ್ತ್ರಚಿಕಿತ್ಸಕ. ರೋಗಿ-ಮೊದಲ, ಸಾಕ್ಷ್ಯಾಧಾರಿತ ಮೂಳೆ ಚಿಕಿತ್ಸೆ.',
    'Consultant Orthopaedic Surgeon in JP Nagar and RR Nagar, Bengaluru. Patient-first, evidence-based orthopaedic care. Joint replacement, sports injury, trauma and fracture care for South Bengaluru.': 'ಜೆ ಪಿ ನಗರ ಮತ್ತು ಆರ್ ಆರ್ ನಗರ, ಬೆಂಗಳೂರಿನಲ್ಲಿ ಕನ್ಸಲ್ಟಂಟ್ ಮೂಳೆ ಶಸ್ತ್ರಚಿಕಿತ್ಸಕ. ರೋಗಿ-ಮೊದಲ, ಸಾಕ್ಷ್ಯಾಧಾರಿತ ಮೂಳೆ ಚಿಕಿತ್ಸೆ. ದಕ್ಷಿಣ ಬೆಂಗಳೂರಿಗೆ ಕೀಲು ಬದಲಾವಣೆ, ಕ್ರೀಡಾ ಗಾಯ, ಟ್ರಾಮಾ ಮತ್ತು ಮುರಿತ ಆರೈಕೆ.',
    'Orthopaedic consultations in JP Nagar and RR Nagar. WhatsApp booking, phone and maps.': 'ಜೆ ಪಿ ನಗರ ಮತ್ತು ಆರ್ ಆರ್ ನಗರದಲ್ಲಿ ಮೂಳೆ ಸಮಾಲೋಚನೆ. ವಾಟ್ಸ್‌ಆ್ಯಪ್ ಬುಕಿಂಗ್, ದೂರವಾಣಿ ಮತ್ತು ನಕ್ಷೆಗಳು.',
    'Orthopaedic care for JP Nagar, RR Nagar & South Bengaluru': 'ಜೆ ಪಿ ನಗರ, ಆರ್ ಆರ್ ನಗರ ಮತ್ತು ದಕ್ಷಿಣ ಬೆಂಗಳೂರಿಗೆ ಮೂಳೆ ಆರೈಕೆ',
    ...
    'Guides written for searches patients actually make before visiting an orthopaedic doctor in JP Nagar or RR Nagar.': 'ಜೆ ಪಿ ನಗರ ಅಥವಾ ಆರ್ ಆರ್ ನಗರದ ಮೂಳೆ ವೈದ್ಯರನ್ನು ಭೇಟಿ ಮಾಡುವ ಮುನ್ನ ರೋಗಿಗಳು ಹುಡುಕುವ ಮಾರ್ಗದರ್ಶಿಗಳು.',
    ...
    'SEO hub for common orthopaedic problems. Jump to a condition or book a visit in JP Nagar or RR Nagar.': 'ಸಾಮಾನ್ಯ ಮೂಳೆ ತೊಂದರೆಗಳ ಕೇಂದ್ರ. ತೊಂದರೆ ಆಯ್ಕೆಮಾಡಿ ಅಥವಾ ಜೆ ಪಿ ನಗರ / ಆರ್ ಆರ್ ನಗರದಲ್ಲಿ ಭೇಟಿ ಕಾಯ್ದಿರಿಸಿ.',
    ...
    'Who is a good orthopaedic doctor in JP Nagar?': 'ಜೆ ಪಿ ನಗರದಲ್ಲಿ ಒಳ್ಳೆಯ ಮೂಳೆ ವೈದ್ಯರು ಯಾರು?',
    'Is there an orthopaedic specialist in RR Nagar?': 'ಆರ್ ಆರ್ ನಗರದಲ್ಲಿ ಮೂಳೆ ತಜ್ಞರಿದ್ದಾರೆಯೇ?',
    ...
    'How do I book an orthopaedic appointment?': 'ಮೂಳೆ ಅಪಾಯಿಂಟ್‌ಮೆಂಟ್ ಹೇಗೆ ಕಾಯ್ದಿರಿಸುವುದು?',
    'Do I need an MRI before the first visit?': 'ಮೊದಲ ಭೇಟಿಗೆ ಮುನ್ನ ಎಂಆರ್‌ಐ ಬೇಕೇ?',
    'Is orthopaedic treatment only surgery?': 'ಮೂಳೆ ಚಿಕಿತ್ಸೆ ಕೇವಲ ಶಸ್ತ್ರಚಿಕಿತ್ಸೆಯೇ?',
    ...
    'Common orthopaedic problems seen in clinic. Tap a card for a short overview.': 'ಕ್ಲಿನಿಕ್‌ನಲ್ಲಿ ಕಾಣುವ ಸಾಮಾನ್ಯ ಮೂಳೆ ತೊಂದರೆಗಳು. ಸಂಕ್ಷಿಪ್ತ ವಿವರಕ್ಕೆ ಕಾರ್ಡ್ ಟ್ಯಾಪ್ ಮಾಡಿ.'
  };
